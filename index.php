        ...
        <div class="container">
            ...
            <div class="row ">
                <div class="offset-xl-4 col-xl-4 offset-lg-4 col-lg-4 col-md-12 col-sm-12 col-12 text-center mt60">
                   <a href="register.php" class="btn btn-default btn-lg btn-block">Get Started</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="offset-xl-3 col-xl-6 offset-lg-3 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="cta-block">
                        ...
                        <a href="register.php" class="btn btn-default">Sign Up Now</a>
                    </div>
                </div>
            </div>
        </div>
